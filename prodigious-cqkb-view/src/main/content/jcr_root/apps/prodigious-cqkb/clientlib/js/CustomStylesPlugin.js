/*
 * This custom plugin allows the interaction with the new custom Font Styles 
 * plugin. Now, a piece of text can contain several <span> tags with different 
 * CSS classes, and the one specified in this menu will be selected in the 
 * dropdown. With the default implementation, the plugin was not able to 
 * recognize its styles when another <span> tag was already applied.
 *
 * @version 1.0
 * @since 06-21-2013
 *
 ...
 * plugin.</p>
 * <p>The plugin ID is "<b>tmostyles</b>".</p>
 * <p><b>Features</b></p>
 * <ul>
...
CQ.form.rte.plugins.StylesPlugin = CQ.Ext.extend(CQ.form.rte.plugins.Plugin, {
    ...
    initializeUI: function(tbGenerator) {
        ...
        if (this.isFeatureEnabled("customstyles")) {
            this.stylesUI = new ui.TbStyleSelector("customstyles", this, "Styles", this.getStyles());
            tbGenerator.addElement("customstyles", plg.Plugin.SORT_STYLES, this.stylesUI, 10);
        }
    },
...
// register plugin
CQ.form.rte.plugins.PluginRegistry.register("customstyles", CQ.form.rte.plugins.StylesPlugin);
